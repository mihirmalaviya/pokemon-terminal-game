...
MOVES_INFO = {
    "pound": {
        ...
        "pp": 35,
        "accuracy": 100,
        "buffs": {"attack": None, "defense": None},
    },
    "karate-chop": {
        "type": "fighting",
        "power": 50,
...
POKEMON_INFO = {
    "bulbasaur": {
        "evolution_chain": [("bulbasaur", 16, "ivysaur"), ("ivysaur", 32, "venusaur")],
    ...
    "caterpie": {
        "evolution_chain": [("caterpie", 7, "metapod"), ("metapod", 10, "butterfree")],
    ...
    "pidgey": {
        "evolution_chain": [("pidgey", 18, "pidgeotto"), ("pidgeotto", 36, "pidgeot")],
    ...
    "rattata": {
        "evolution_chain": [("rattata", 20, "raticate"), ("rattata", 20, "raticate")],
    ...
    "golbat": {
        "evolution_chain": [("zubat", 22, "golbat"), ("golbat", None, "crobat")],
        "starting_moves": ["bite", "absorb", "quick-attack", "screech", "leech-life"],
        "learned_moves": [
            ("wing-attack", 32),
            ("supersonic", 10),
            ("confuse-ray", 21),
    ...
    "chansey": {
        "evolution_chain": [("happiny", None, "chansey"), ("chansey", None, "blissey")],
    ...
    "mr-mime": {
        "evolution_chain": [("mime-jr", None, "mr-mime"), ("mr-mime", 42, "mr-rime")],
    ...
    "flareon": {
        ...
        "starting_moves": ["sand-attack", "tackle", "growl", "ember", "quick-attack"],
        "learned_moves": [
            ("double-kick", 10),
            ("tail-whip", 37),
            ("leer", 42),
    ...
    "mewtwo": {
        "evolution_chain": [],
        "starting_moves": ["disable", "confusion", "psychic", "confuse-ray", "swift"],
        "learned_moves": [
            ("mist", 75),
            ("psybeam", 22),
            ("agility", 88),
