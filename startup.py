...
npcs_info = {
    "dr ock": {"pokemon": ["pikachu"], "money": 1000, "exp": 900, "progress": 7000},
    "gabe": {
    ...
    "fly guy": {
        "pokemon": sorted(
            ["butterfree", "zubat", "pidgeotto"]
        ),  # sort here, this is important because i was too lazy to move zubat but the sort does it for me
        "money": 7500,
        "exp": 17000,
        "progress": 40000,
    },
